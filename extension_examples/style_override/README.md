# style_override — Cyberpunk theme
...
```bash
LLM_WEBCHAT_STATIC_PATHS=extension_examples/style_override/cyberpunk.css \
  LLM_WEBCHAT_JAVASCRIPT_PLUGINS=extension_examples/style_override/cyberpunk-loader.js \
  llm webchat
```
